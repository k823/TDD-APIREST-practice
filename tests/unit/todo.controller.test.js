...
let req, res, next; 
const todoId = "5e34045192c3f8218ee9753d"
...
describe("TodoController.getTodos", () => {
    ...
    it("should return 404 when item doesen't exist", async () => {
...
describe("TodoController.createTodo", () => {
    ...
    it("sould call TodoModel.create", () => {
        TodoController.createTodo(req, res, next);
        expect(TodoModel.create).toBeCalledWith(newTodo);
    });

    it("sould return 201 response code", async () => {
